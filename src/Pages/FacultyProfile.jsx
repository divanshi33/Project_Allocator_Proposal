...
function FacultyProfile() {
  ...
  const saveProfile = async () => {
    ...
    try {
      await axios.post(`${import.meta.env.VITE_API_BASE_URL}/api/faculty/save-profile`, {
        email,
        name,
  ...
  const addTopic = async () => {
    ...
    try {
      await axios.post(`${import.meta.env.VITE_API_BASE_URL}/api/topics/add`, {
        title: newTitle,
        language: newLang,
        email
      });
  ...
  return (
    <div className="profile-container">
      ...
      <div className="profile-topBar">
        ...
        <button className="back-btn" onClick={logout} style={{ background: "#e53e3e", color: "#fff", border: "none" }}>
          Logout
        </button>
      </div>
